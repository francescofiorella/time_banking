...
class SignInFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        userModel.loggedIn.observe(viewLifecycleOwner) {
            Log.d("DEBUG", "SignInFragment - userModel.loggedIn.observe - $it")
            if (it) {
                findNavController().navigate(R.id.action_signInFragment_to_timeSlotListFragment)
            }
        }

        userModel.signInErrorMessage.observe(viewLifecycleOwner) { errorMessage ->
            Log.d("DEBUG", "SignInFragment - userModel.signInErrorMessage.observe - $errorMessage")
            if (errorMessage != "") {
                Snackbar
                    .make(
                    ...
                    .setAction("DISMISS") {}
                    .show()
                userModel.clearSignInErrorMessage()
            }
        }
